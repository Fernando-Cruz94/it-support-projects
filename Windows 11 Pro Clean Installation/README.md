...
- Used Windows Media Creation Tool to create a bootable USB with Windows 11 Pro.

### 2. System Installation
- Booted from USB
- Deleted all partitions
- Created custom partition layout
- Installed Windows 11 Pro on the `C:` drive
...
### ✅ Driver Setup
- Installed all updates via Windows Update (including optional)
- Installed graphics drivers via NVIDIA App
- Used Snappy Driver Installer Origin to install missing drivers
- Verified device status in Device Manager

### 🧠 Daily Software Installation via [Ninite](https://ninite.com/)
Installed essential software silently and efficiently:
- .NET 4.8.1  
- Discord  
- Firefox  
- GIMP  
...
- [Snappy Driver Installer Origin](https://sdi-tool.org/)
- [Ninite Official Site](https://ninite.com/)
- [Windows 11 Download Page](https://www.microsoft.com/en-us/software-download/windows11)
- [NVIDIA App Download](https://www.nvidia.com/en-us/geforce/geforce-experience/)
